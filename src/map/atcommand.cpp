...
ACMD_FUNC(go)
{
	...
	const struct {
		...
		{ MAP_PRONTERA,    155, 180 }, //  0=Prontera
		{ MAP_MORROC,      156,  45 }, //  1=Morroc
		{ MAP_GEFFEN,      120,  98 }, //  2=Geffen
		{ MAP_PAYON,       162, 233 }, //  3=Payon
		{ MAP_ALBERTA,     220, 98 }, //  4=Alberta
#ifdef RENEWAL
		...
		{ MAP_LUTIE,       147, 118 }, //  7=Lutie
		{ MAP_COMODO,      188, 164 }, //  8=Comodo
		{ MAP_YUNO,        157,  77 }, //  9=Yuno
		{ MAP_AMATSU,      200,  200 }, // 10=Amatsu
		...
		{ MAP_CELESTIAJ,     60, 77 }, // 37=Celestiaj
	};
	...
	if (strncmp(map_name, "prontera", 3) == 0) {
		...
		town = 36;
	}else if (strncmp(map_name, "celestiaj", 2) == 0) {
		town = 37;
	}
